      ...
      <div id="vlaanderen-footer-info">
          ...
          <div id="vlaanderen-footer-info-publisher">
            ...
            <span itemprop="publisher" itemscope="" itemtype="http://schema.org/Organization">
              <a itemprop="url" href="https://www.vlaanderen.be/nl/contact/adressengids/diensten-van-de-vlaamse-overheid/administratieve-diensten-van-de-vlaamse-overheid/beleidsdomein-kanselarij-en-bestuur/agentschap-informatie-vlaanderen" target="_self"><span itemprop="name">het Agentschap Informatie Vlaanderen</span></a><span id="version"></span>
            </span>
          </div>
      </div>
    </div>
