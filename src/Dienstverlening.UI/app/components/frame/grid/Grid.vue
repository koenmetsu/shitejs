...
export default class Grid extends Vue {
  @Prop({ default: false })
  modIsStacked: boolean

  @Prop({ default: false })
  modIsCenter: boolean

  @Prop({ default: false })
  modIsStretched: boolean
